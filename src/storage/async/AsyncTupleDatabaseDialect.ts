...
import {
	AsyncTupleDatabaseApi2,
	AsyncTupleDatabaseDialectApi,
	AsyncTupleTransactionApi2,
} from "./types"

class AsyncTupleDatabaseDialect<S extends TupleValuePair>
	implements AsyncTupleDatabaseDialectApi<S>
{
	constructor(
		private db: AsyncTupleDatabaseApi2,
...
export class AsyncTupleTransaction2<S extends TupleValuePair>
	implements AsyncTupleTransactionApi2<S>
{
	constructor(
		private db: AsyncTupleDatabaseApi2,
		public subspacePrefix: Tuple,
...
{
	constructor(
		private tx: AsyncTupleTransactionApi2<any>,
		public subspacePrefix: Tuple
	) {}
